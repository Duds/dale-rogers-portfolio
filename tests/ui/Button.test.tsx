...
describe('Button Component', () => {
  ...
  describe('Disabled State', () => {
    ...
    it('does not call onClick when disabled', async () => {
      ...
      renderWithProviders(<Button disabled {...defaultProps} onClick={handleClick} />);
  ...
  describe('Customization', () => {
    it('applies custom className', () => {
      renderWithProviders(<Button className="custom-class" {...defaultProps} />);
      const button = screen.getByRole('button');
    ...
    it('forwards additional props', () => {
      renderWithProviders(<Button data-testid="test-button" {...defaultProps} />);
  ...
  describe('Accessibility', () => {
    ...
    it('supports aria-label', () => {
      renderWithProviders(<Button aria-label="Custom label" {...defaultProps} />);
  ...
  describe('Edge Cases', () => {
    ...
    it('combines multiple variants correctly', () => {
      renderWithProviders(
        <Button variant="outline" size="lg" className="custom" {...defaultProps} />
      );
      const button = screen.getByRole('button');
