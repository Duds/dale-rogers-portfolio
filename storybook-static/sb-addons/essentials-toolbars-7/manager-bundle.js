  ...
  (() => {
    ...
    var F = { type: "item", value: "" },
      K = (t, o) => ({
        ...
        toolbar: {
          ...o.toolbar,
          items: o.toolbar.items.map((e) => {
            let r = typeof e == "string" ? { value: e, title: e } : e;
            return (
              r.type === "reset" &&
                o.toolbar.icon &&
                ((r.icon = o.toolbar.icon), (r.hideIcon = !0)),
              { ...F, ...r }
            );
          }),
        },
      ...
      Y = ["reset"],
      z = (t) => t.filter((o) => !Y.includes(o.type)).map((o) => o.value),
      b = "addon-toolbars",
      $ = async (t, o, e) => {
        (e &&
          e.next &&
          (await t.setAddonShortcut(b, {
            label: e.next.label,
      ...
      q = (t) => (o) => {
        ...
        return (
          C(() => {
            l &&
              $(d, e, {
                next: { ...l.next, action: O },
                previous: { ...l.previous, action: I },
                reset: { ...l.reset, action: f },
              });
          }, [d, e, l, O, I, f]),
          C(() => {
            a.current = z(r);
          }, []),
          n.createElement(t, { cycleValues: a.current, ...o })
        );
      },
      G = ({ currentValue: t, items: o }) =>
        t != null && o.find((e) => e.value === t && e.type !== "reset"),
      j = ({ currentValue: t, items: o }) => {
        let e = G({ currentValue: t, items: o });
        if (e) return e.icon;
      },
      J = ({ currentValue: t, items: o }) => {
        let e = G({ currentValue: t, items: o });
      ...
      Q = ({
        ...
        n.createElement(
          D,
          { active: t, title: l, disabled: o, onClick: o ? () => {} : d },
          r &&
      ...
      X = q(
        ({
          ...
          (S || (c = j({ currentValue: s, items: l }) || c),
            i && (_ = J({ currentValue: s, items: l }) || _),
            !_ && !c && console.warn(`Toolbar '${o}' has no title or icon`));
          let U = v(
            (h) => {
              u({ [t]: h });
            },
      ...
      ee = () => {
        let t = B(),
          o = Object.keys(t).filter((e) => !!t[e].toolbar);
        return o.length
          ? n.createElement(
              n.Fragment,
              null,
