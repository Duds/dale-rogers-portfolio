...
- Name: FormattedDate component renders a date
- Location: /home/dale-rogers/dev/personal/dale-rogers-portfolio/tests/ui/formatteddate.spec.ts:3:1
...
Locator: getByText(/2024|2023|2022/)
Expected: visible
Received: <element(s) not found>
Call log:
  - expect.toBeVisible with timeout 5000ms
  - waiting for getByText(/2024|2023|2022/)

    at /home/dale-rogers/dev/personal/dale-rogers-portfolio/tests/ui/formatteddate.spec.ts:7:22
```
...
```ts
  ...
  2 |
  3 | test("FormattedDate component renders a date", async ({ page }) => {
  4 |   await page.goto("/");
  5 |   // Adjust date text as needed
  6 |   const date = await page.getByText(/2024|2023|2022/);
> 7 |   await expect(date).toBeVisible();
    |                      ^ Error: Timed out 5000ms waiting for expect(locator).toBeVisible()
  8 | });
  9 |
```
