...
- Name: SectionHeading component renders heading
- Location: /home/dale-rogers/dev/personal/dale-rogers-portfolio/tests/ui/sectionheading.spec.ts:3:1
...
Locator: getByRole('heading', { name: /services|case studies|my values/i })
Expected: visible
Received: <element(s) not found>
Call log:
  - expect.toBeVisible with timeout 5000ms
  - waiting for getByRole('heading', { name: /services|case studies|my values/i })

    at /home/dale-rogers/dev/personal/dale-rogers-portfolio/tests/ui/sectionheading.spec.ts:9:25
```
...
```ts
   ...
   2 |
   3 | test("SectionHeading component renders heading", async ({ page }) => {
   4 |   await page.goto("/");
   5 |   // Adjust heading text as needed
   6 |   const heading = await page.getByRole("heading", {
   7 |     name: /services|case studies|my values/i,
   8 |   });
