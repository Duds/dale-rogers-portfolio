...
const CONTENT_MAPPING = {
  ...
  'developing-a-robust-doctrine-application-for-the-antarctic.mdx': {
    ...
    rssDate: 'Mon, 09 Dec 2024 22:59:23 +0000',
  },
  ...
  'developing-a-bespoke-pmo-as-a-service-for-rio-tinto-aluminium.mdx': {
    url: '/work/developing-a-bespoke-pmo-as-a-service-for-rio-tinto-aluminiu',
    rssDate: 'Mon, 09 Dec 2024 23:35:13 +0000',
  },

  // Articles - these are accessible via /think/[slug]
  'poka-yoke-in-service-design-and-user-experience.mdx': {
    url: '/think/poka-yoke-in-service-design-and-user-experience',
    rssDate: 'Tue, 12 Mar 2024 17:06:58 +0000',
  },
  'service-design-in-the-era-of-remote-work.mdx': {
    url: '/think/service-design-in-the-era-of-remote-work-adapting-to-new-way',
    rssDate: 'Tue, 12 Mar 2024 17:06:58 +0000',
  },
  'how-to-embed-continuous-improvement.mdx': {
    url: '/think/how-to-embed-continuous-improvement-in-your-organisation',
    rssDate: null,
  },
  'five-elements-of-service-design-for-government.mdx': {
    url: '/think/five-elements-of-service-design-for-governments',
    rssDate: null,
  },
  'how-the-design-thinking-process-works-in-government.mdx': {
    url: '/think/how-the-design-thinking-process-works-in-government',
    rssDate: 'Tue, 12 Mar 2024 17:06:58 +0000',
  },
  'what-is-service-design.mdx': {
    url: '/think/what-is-service-design',
    rssDate: null,
  },

  // Articles that may not be published on the live site yet
...
async function updateFileDate(filePath, newDate) {
  try {
    ...
    if (content.includes('pubDate:')) {
      ...
      const updatedContent = content.replace(/pubDate:\s*["']?[\d-]+["']?/, `pubDate: ${newDate}`);
